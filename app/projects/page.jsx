...
const ALL_PROJECTS = [
  {
    n: '01', title: 'LeetRepeat', year: 'May 2026', status: 'Active',
    image: '/images/leetrepeat.png',
    blurb: 'Chrome extension that brings Anki-style spaced repetition to LeetCode practice.',
    detail: 'Built a Manifest V3 Chrome extension that schedules LeetCode problems using the SM-2 spaced repetition algorithm, the same system behind Anki. On install, a content script imports solve history via LeetCode\'s internal GraphQL API and assigns staggered due dates based on recency. Submission detection runs via MutationObserver. When an "Accepted" verdict appears, a rating modal (Easy / Medium / Hard) triggers an SM-2 interval update. The popup dashboard shows today\'s queue, a calendar heatmap, and a weak-area breakdown by tag.',
    tags: ['Chrome Extension', 'JavaScript', 'SM-2', 'GraphQL'],
    links: [{ label: 'GitHub', url: 'https://github.com/SacchinS/LeetRepeat' }],
  },
  {
  ...
  {
    n: '03', title: 'Sixers Fantasy', year: 'Oct 2025 – Present', status: 'Active',
  ...
  },
  {
    ...
    links: [{ label: 'Devpost', url: 'https://devpost.com/software/taskflow-qv6z7m' }],
  },
  {
    n: '06', title: 'Husky Robotics', year: '2025', status: 'Active',
  ...
  },
  {
    ...
    links: [{ label: 'GitHub', url: 'https://github.com/SacchinS/Gladiator-Games' }],
  },
  {
    ...
    links: [
      { label: 'GitHub', url: 'https://github.com/SacchinS/Verdantia-Website-State' },
      { label: 'Figma', url: 'https://www.figma.com/design/96UFyOSY4bp5GV8UMeft2z/--------Copy-?t=QDwRMZGcX60knc0O-1' },
    ],
  },
  {
    ...
    links: [
      { label: 'GitHub', url: 'https://github.com/SacchinS/ShapeShift' },
      { label: 'App Store', url: 'https://apps.apple.com/us/app/shapeshift-learn/id6461162324' },
    ],
  },
  {
    ...
    links: [{ label: 'itch.io', url: 'https://ss323.itch.io/the-last-iceberg' }],
  },
